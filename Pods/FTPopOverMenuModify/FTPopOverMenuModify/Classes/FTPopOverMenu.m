...
#define FTDefaultCoverBackgroundColor       [UIColor clearColor]
...
#define FTDefaultCellSelectedBackgroundColor    [UIColor whiteColor]
...
#define FTDefaultClearColor                 [UIColor clearColor]
...
- (instancetype)init {
    ...
    if (self) {
        ...
        self.coverBackgroundColor = FTDefaultCoverBackgroundColor;
...
- (UITableView *)menuTableView {
    if (!_menuTableView) {
        ...
        _menuTableView.backgroundColor = FTDefaultClearColor;
...
- (UIView *)backgroundView {
    if (!_backgroundView) {
        ...
        _backgroundView.backgroundColor = FTDefaultClearColor;
    }
